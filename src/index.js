...
var App = function () {
    return ((0, jsx_runtime_1.jsx)(react_1.StrictMode, { children: (0, jsx_runtime_1.jsx)(material_1.Box, { display: 'flex', justifyContent: 'center', height: '100dvh', width: '100dvw', className: 'blue-purple-gradient-bg', children: (0, jsx_runtime_1.jsxs)(material_1.Box, { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '2rem', zIndex: '1', children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h1", fontWeight: 'bolder', children: "Meal Planner" }), (0, jsx_runtime_1.jsx)(material_1.Button, { href: "/auth/google", variant: 'contained', children: "Log in with Google" }), (0, jsx_runtime_1.jsx)(material_1.Button, { href: "/isloggedin", variant: 'contained', children: "Try in Sandbox Mode" })] }) }) }));
};
